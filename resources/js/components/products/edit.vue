            ...
            <div class="products__create__cardWrapper mt-2">
                ...
                <div class="products__create__sidebar">
                    ...
                    <div class="card py-2 px-2 bg-white">
                        ...
                        <div class="my-3">
                            <p>Product type</p>
                            <input type="text" v-model="form.type" class="input" >
                        </div>
                        <hr>
                        ...
                        <div class="my-3">
                            <p>Inventory</p>
                            <input type="text" v-model="form.quantity" class="input" >
                        </div>
                        <hr>
...
const getSingleProduct = async () => {
    let response = await axios.get(`/api/get-product/${props.id}`)
...
const updateProduct = () => {
    ...
    axios.post(`/api/update-product/${form.value.id}`, formData)
        .then((response) => {
            form.value.name = '',
